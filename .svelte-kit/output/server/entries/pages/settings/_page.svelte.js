import { Z as head, a0 as attr } from "../../../chunks/index2.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--></div></div> <div><label class="block text-sm font-medium text-gray-700 mb-2">Ảnh Người Yêu</label> <div class="space-y-3">`);
    if (avatar2Preview) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="flex items-center space-x-3"><img${attr("src", avatar2Preview)} alt="Ảnh người yêu" class="w-16 h-16 rounded-full object-cover border-2 border-purple-200"/> <div><p class="text-sm text-gray-600">Ảnh đã tải lên</p> <button class="text-xs text-red-600 hover:text-red-700">Xóa</button></div></div>`);
    } else {
      $$renderer2.push("<!--[!-->");
